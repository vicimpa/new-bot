#!/usr/bin/env ts-node
import { CategoryChannel, GuildMember, Permissions } from "discord.js";
import { PermissionOverwrites, PermissionString, Role, VoiceChannel } from "discord.js";
import { blockLimit, createdName, guildId, privates, removePrivateAfter } from "~/config";
